  ...
  const faqSections = [
    {
      ...
      questions: [
        ...
        {
          question: "What are the conditions for investing on DreReal Estate Investment PlatformamProperty?",
          answer: "Any person of legal age can hold a Real Estate Investment Platform NFT! Investing is simple - you merely need to have VeChain wallet and you are ready to buy one or more Real Estate Investment Platform NFTs."
        },
        {
          question: "Can I invest with a company or SCI?",
          answer: "Of course you can! As for an individual you need the same things, i.e. to hold one or more Real Estate Investment Platform NFTs."
        },
        {
        ...
        {
          question: "Do you become a homeowner by buying NFTs on Real Estate Investment Platform?",
          answer: "When you buy NFTs on Real Estate Investment Platform, you are not actually buying part of a property, nor do you become an owner. You hold royalties, which means that you are entitled to receive a royalty on the rents and capital gains generated by the property in which you invest. The amount of these royalties is paid to you every month, depending on the number of NFTs you own. The advantage: an immediate return on investment with income paid every month (linked to the rents collected), without the management, financing or tax constraints associated with traditional rental investment!"
        },
        {
        ...
        },
        {
          ...
          answer: 'The "Return on investment" corresponds to the excess part of the rents which will be paid to you after deduction of the amortization of the expenses, and, if necessary, the Real Estate Investment Platformayment of credit. The "Profitability" corresponds to the returned income to which are added the real estate capital gain and the mechanical increase in the price of the NFT due to the amortization of the real estate loan present on the property in question.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Gross rents are the rents paid by tenants every month. Net rents are the gross rents minus charges, provisions and loan repayments. It is the net rents that are paid out each month as royalties to the NFT Real Estate Investment Platform holders. The amount may fluctuate depending on the rents collected and the current charges."
        },
        {
          question: "How does Real Estate Investment Platform pay itself?",
          answer: "Real Estate Investment Platform takes no entry fees, no exit fees and no fees on capital gains. The fees applied are as follows: i. 10% of the purchase amount (in primary sales).  So you take an entry fee ii. 10% secondary market fee. So the person buying takes an entry fee iii. 1% rental management fee."
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'In accordance with the French law "Informatique et Libertés", Real Estate Investment Platform is committed to respecting the regulatory and ethical provisions on the protection of personal data. The information you provide when you register is stored on the platform in a secure and encrypted manner. Under no circumstances will Real Estate Investment Platform sell your personal information to third parties.'
        },
        {
